...
export const subFormItems: FormFieldItem[] = [
  ...
  {title: 'ATK Buff(%)', type: 'input', modelName: ATK_BUFF, initialValue: 100, tooltip: '攻擊力Buff — 敵方防禦力Buff — 敵方特防威力Buff'},
  {title: '色卡 Buff(%)', type: 'input', modelName: CARD_BUFF, initialValue: 100, tooltip: '色卡Buff — 敵方色卡耐性Buff'},
  {title: '寶具威力 Buff(%)', type: 'input', modelName: NP_BUFF, initialValue: 100},
  {title: '特攻威力 Buff(%)', type: 'input', modelName: SPECIAL_BUFF, initialValue: 100},
  {title: '寶具特攻 Buff(%)', type: 'input', modelName: SPECIAL_NP_BUFF, initialValue: 100},
  {title: '攻擊補正 (%)', type: 'input', modelName: CORRECTION, initialValue: 100},
